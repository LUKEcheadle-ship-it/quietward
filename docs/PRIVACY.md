...
Early pre-rename alpha state could contain raw authentication usernames. Current releases prevent new raw username persistence. Users upgrading from that early alpha should archive the old state privately and begin a fresh database.
